...
p.add_node("1", rescale(.9), guess(rescale(.9)), size=0)
p.add_node("2", rescale(.9), fs[-1](rescale(.9)), size=0)
p.add_edge(["1","2"])


p.show(width=700, height=400, show_legend=False, file_name="example_distribution_prediction.html")
