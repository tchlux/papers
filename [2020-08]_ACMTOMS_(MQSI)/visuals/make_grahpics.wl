...
q1[x_] := x^2;
q2[x_] := (x-2)^2 + 6;
quadraticSensitivity["1-sensitivity.pdf", {-1.5,-0.5,0.0,0.5,1.5}, q1, q2]
...
makePlot["2-piecewise-polynomial.pdf", x, y, m=1000];
...
makePlot["3-large-tangent.pdf", x, y, m=1000];
...
makePlot["4-signal-decay.pdf", x, y, m=1000];
...
approx = makePlot["5-real-data.pdf", x, y, m=1000];
...
makeZoomedPlot["6-random-monotone.pdf", x, y, m=1000, width=450, height=350];
...
chart = stackedBarChart[tempData, tempSizes, {red, green, blue},
			"Time (seconds)", ""];
Export["7-runtimes-10.pdf",chart];
...
Export["8-runtimes-100.pdf",chart];
