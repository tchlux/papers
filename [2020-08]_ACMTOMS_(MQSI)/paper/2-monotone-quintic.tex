...
[Moler 2008], however this method also yields approximations with
large {\it wiggle}, or whose second derivative functions have large
$L2$ norm over the domain. In an attempt to capture the local shape of
