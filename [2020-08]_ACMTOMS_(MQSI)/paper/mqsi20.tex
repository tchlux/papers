...
\refj{Costantini, P.}{1997}{Boundary-valued shape-preserving
  interpolating splines}{ACM Transactions on Mathematical Software
  (TOMS)}{23(2):229--251}

%% BVSPIS Algorithm.
\refj{Costantini, P.}{1997}{Algorithm 770: BVSPIS—a package for
  computing boundary-valued shape-preserving interpolating
  splines}{ACM Transactions on Mathematical Software (TOMS)}{23(2):252-–254}
...
\refj{Cravero, I., C. Manni}{2003}{Shape-preserving interpolants with
...
\refj{Delbourgo, R., Gregory, J. A.}{1983}{$C^2$ rational quadratic
...
%% Accompanies the previous error bounds in the context of monotone
%% polynomial interpolation of data from a monotone function.
\refj{DeVore, R. A.}{1977}{Monotone approximation by polynomials}{SIAM
  Journal on Mathematical Analysis}{8(5):906--921}
...
\refj{Dougherty, R. L., Edelman, A., Hyman,
...
\refj{Fiorot, J. C., Tabka, J.}{1991}{Shape-preserving $C^2$ cubic
  polynomial interpolating splines}{Mathematics of
  Computation}{57(195):291--298}
...
\refj{Gregory , J. A.,Delbourgo, R.}{1982}{Piecewise rational
...
\refj{Manni, C., Sablonni\`ere, P.}{1997}{Monotone interpolation of
...
\refj{Zhu, Y.,Han, X.}{2015}{$C^2$ rational quartic interpolation
...
\refj{Zhu, Y.,Han, X.}{2015}{Shape preserving $C^2$ rational quartic
