...
Algorithms \red{1 and 4 have ${\cal O}(n)$ runtime for $n$ data
...
wiggle (\red{local} $L^2$ norm of the second derivative) than other methods. A
...
\narrower\noindent\rmVIII Fig.\ 1. A demonstration of the quadratic
  ...
  curvature \red{(equal second derivatives)}. Given the exact five data points
